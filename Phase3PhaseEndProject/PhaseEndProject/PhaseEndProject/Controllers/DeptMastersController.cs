...
namespace PhaseEndProject.Controllers
{
    ...
    {
        private readonly PhaseEndProjectContext _context;

        public DeptMastersController(PhaseEndProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<DeptMaster>> PostDeptMaster(DeptMaster deptMaster)
        {
          if (_context.DeptMaster == null)
          {
              return Problem("Entity set 'PhaseEndProjectContext.DeptMaster'  is null.");
          }
